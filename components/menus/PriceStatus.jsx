...
const PriceStatus = () => {
    ...
    return (
        <div className=" w-316  bg-secondary rounded-md overflow-x-hidden h-full max-h-560 scrollbar-thin scrollbar-thumb-secondary7 scrollbar-track-secondary8 scrollbar-thumb-rounded-2xl">
