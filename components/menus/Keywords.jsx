            ...
            <div className="flex flex-col mt-2.5">
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center">
                        <input type="text" className="bg-transparent outline-none w-216 h-36 border border-secondary9 py-2 px-3 text-pricol1 hover:border-secondary10 focus:text-white focus:border-yellow" placeholder="Type keywords..." style={{borderRadius:'4px'}} value={include} onChange={(e)=>setInclude(e.target.value)} />
                ...
                <div className="flex flex-col mt-5">
                    ...
                    <div className="flex items-center">
                        <input type="text" className="bg-transparent outline-none w-216 h-36 border border-secondary9 py-2 px-3 text-pricol1 hover:border-secondary10 focus:text-white focus:border-yellow" placeholder="Type keywords..." style={{borderRadius:'4px'}} value={exclude} onChange={(e)=>setExclude(e.target.value)}/>
                        <span className="ml-4 font-noto text-13 text-yellow cursor-pointer" onClick={()=>{
                            if(exclude){
                                dispatch({
                                    type:KEYWORDS_BTN,
