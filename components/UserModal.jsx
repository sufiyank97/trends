    ...
    return (
        <div className="flex flex-col w-full">
            <div className="flex justify-between">
                <h1 className="capitalize text-pricol1 text-12_20 font-noto">my account</h1>
            ...
            <div className="flex flex-col p-4">
                ...
                <div className="flex flex-col">
                    <h1 className="capitalize text-pricol1 text-12_20 font-noto">teams</h1>
                ...
                <div className="flex flex-col mt-4">
                    <h1 className="capitalize text-pricol1 text-12_20 font-noto">language setting</h1>
                    <select name="" id="" className="m-2 p-1 bg-transparent text-12_20 text-pricol1 border-2 rounded outline-none" style={{borderColor:'#8b8b95'}}>
