    ...
    return (
        <div className="fixed flex justify-center items-center h-88 w-full z-20" style={{background:'rgba(51, 52, 73, 0.9)'}}>
            ...
            <div className="flex items-center ml-4">
                <button className="capitalize focus:outline-none bg-secondary1 text-white px-2 py-1 rounded-md text-12_20 font-noto" onClick={()=>dispatch({type:COOKIES_DATA,payload:true})}>accept</button>
                <h1 className="text-white mx-4 text-12_20 font-noto">or</h1>
                <h1 className="text-secondary1 text-12_20 cursor-pointer font-noto">more info</h1>
            </div>
        </div>
    )
}
